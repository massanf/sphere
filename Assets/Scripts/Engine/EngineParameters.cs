...
namespace Evolutionary
{
    ...
    {
        public static int TourneySize = 2;
        public static int MinGenerations = 25;
        public static int MaxGenerations = 10000;
        public static int StagnantGenerationLimit = 30;
        public static double ElitismRate = 0.01;
        public static int PopulationSize = 9;
        public static bool IsLowerFitnessBetter = false;
        public static double CrossoverRate = 0.9;
        public static double MutationRate = 0.4;
        public static int RandomTreeMinDepth = 2;
        public static int RandomTreeMaxDepth = 6;
